...
> Backlog item · KuiReact id `forum-post-status-badge` · layer `domain` · **Domain — Forum** · Priority **Low** · Complexity **Small** · Wave 3 · Fit `adapt` · est. 0.5–1 d
...
| | |
| --- | --- |
| Source | `kui-react/modules/domains/forum/post/PostStatusBadge.tsx` (1 file, 19 LOC) |
...
Parsed from `modules/domains/forum/post/PostStatusBadge.tsx`. **Required** = not optional in KuiReact's type. The KuiNative API must keep these names and defaults unless the RN column says otherwise.

| Prop | Type | Required | Default | Notes | RN mapping |
| --- | --- | --- | --- | --- | --- |
| `status` | `ForumPostStatus` | **yes** | — |  | same |
...
- Location: `modules/domains/forum/PostStatusBadge.tsx`, named export `PostStatusBadge` (same name as KuiReact), re-exported from the layer barrel.
...
- [ ] Exported as `PostStatusBadge` from the `modules/domains/forum` barrel with its props type
